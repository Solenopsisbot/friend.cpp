	...
	// Sampling
	{
		...
		settings: [
			...
			},
			{
				...
				label: 'Blue noise',
				sync: { paramType: SyncableParameterType.BOOLEAN, serverKey: SETTINGS_KEYS.BLUE_NOISE },
				type: SettingsFieldType.CHECKBOX
			},
			{
				...
				label: 'RNG type',
				sync: { paramType: SyncableParameterType.STRING, serverKey: SETTINGS_KEYS.RNG_TYPE },
				type: SettingsFieldType.INPUT
			},
			{
				defaultValue: undefined,
