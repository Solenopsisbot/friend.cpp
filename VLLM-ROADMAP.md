...
| [~] | 11. Expanded structured outputs | Cached JSON Schema/object handling now accepts vLLM-style structured/guided JSON and choices, with live choice-constraint coverage. Regex/backend selection and concurrent/speculative/streaming interaction coverage remain. |
